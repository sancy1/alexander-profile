...
# from .models import Contact, NewsletterSubscriber, DeletedSubscriber, NewsletterCampaign
...
class ContactSerializer(serializers.ModelSerializer):
    class Meta:
        model = Contact
        fields = ['id', 'name', 'phone', 'email', 'subject', 'message', 'created_at', 'is_read']
        # CRITICAL FIX: Removed 'is_read' from here so Django allows updates from Next.js
