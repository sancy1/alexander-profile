    ...
    def post(self, request, *args, **kwargs):
        try:
            ...
            if (
                ...
                and google_response.status_code == 200
            ):
                return Response(
                    {
                        "status": "success",
...
class SwitchAccountView(APIView):
    ...
    def get(self, request, *args, **kwargs):
        try:
            ...
            return redirect(
                "/accounts/google/login/?process=login&prompt=select_account"
            )
...
class RegisterView(generics.CreateAPIView):
    ...
    def create(self, request, *args, **kwargs):
        ...
        try:
            ...
            if settings.DEBUG:
                response_data["debug"] = {"user_id": user.id, "email": user.email}
...
class ProfileView(generics.RetrieveUpdateAPIView):
    ...
    def get_object(self):
        ...
        try:
            ...
            is_social_auth = (
                hasattr(user, "socialaccount") and user.socialaccount.exists()
            )
            ...
            logger.error(
                f"Profile retrieval error for user {self.request.user.id}: {str(e)}"
            )
    ...
    def update(self, request, *args, **kwargs):
        ...
        try:
            ...
            validation_result = ProfileValidator.validate_update_data(
            ...
            if isinstance(
                instance, Response
            ):  # If a generic error occurred in get_object
                return instance
            ...
            changes = ProfileService.get_changed_fields(
                instance, serializer.validated_data, self.serializer_class.Meta.fields
            )
            logger.info(
    ...
    def destroy(self, request, *args, **kwargs):
        ...
        try:
            ...
            logger.error(
                f"Profile deletion failed for user {request.user.id}: {str(e)}"
            )
    ...
    def perform_destroy(self, instance):
        try:
            ...
            raise ProfileDeletionError(
                detail="An unexpected error occurred during profile deletion."
            )
    ...
    def post(self, request):
        ...
        try:
            ...
            raise PasswordResetError(
                "An unexpected error occurred during the password reset request."
            )
...
class ResendVerificationEmailView(APIView):
    ...
    ]  # Or maybe IsAuthenticated if you only want logged-in users to resend
...
class DeleteAccountView(APIView):
    ...
    def delete(self, request, *args, **kwargs):
        try:
            deletion_report = AdminUserDeletionService.delete_user_and_related_data(
                request.user
            )
            response = Response(
                {
...
class UpdateUserRoleView(APIView):
    ...
    def put(self, request, user_id):
        ...
        if not (
            ...
            or (request.user.role == UserRole.ADMIN.value and request.user.is_staff)
        ):
            logger.warning(
                f"Unauthorized role/permission change attempt by {request.user.email}"
            )
            return Response(
        ...
        new_is_superuser = serializer.validated_data.get(
