...
class IsAdminOrAuthor(permissions.BasePermission):
    ...
    def has_object_permission(self, request, view, obj):
        return bool(
            request.user and (request.user.is_staff or obj.author == request.user)
        )
...
class IsOwnerOrAdmin(permissions.BasePermission):
    ...
    def has_object_permission(self, request, view, obj):
        return bool(
            request.user and (request.user.is_staff or obj.owner == request.user)
        )
...
class IsAdminOrSuperUser(permissions.BasePermission):
    ...
    def has_permission(self, request, view):
        ...
        # Regular admin check
        return user.role == UserRole.ADMIN.value and user.is_staff  # Extra safeguard
