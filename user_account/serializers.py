...
class ProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        read_only_fields = ("id", "initials", "image_url", "created_at", "updated_at")
...
class UserDetailSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        read_only_fields = [
            ...
            "email",
            "date_joined",
        ]  # Removed 'created_at', 'updated_at' as they are not in the model fields listed
...
class UpdateUserRoleSerializer(serializers.Serializer):
    role = serializers.ChoiceField(
        choices=[(role.value, role.name) for role in UserRole], required=True
    )
