...
#                 target=self._ping_render, daemon=True, name="render_keepalive"
#             )
...
#         print(
#             f"{Fore.BLUE}🔄 Render.com ping active (every {interval//60} mins){Style.RESET_ALL}"
#         )
...
#                     print(error_msg)
#                     logger.warning(
#                         "Render.com ping unexpected response",
#                         extra={
#                             "status_code": response.status_code,
...
#                 error_msg = (
#                     f"{Fore.RED}✗ Ping failed: {type(e).__name__}{Style.RESET_ALL}"
#                 )
#                 print(error_msg)
#                 logger.error(
#                     "Render.com ping failed",
#                     exc_info=True,
#                     extra={
