...
urlpatterns = [
    ...
    path(
        ...
        SocialLoginRedirectView.as_view(),
    ...
    path(
        ...
        DeleteAllUsersExceptAdminView.as_view(),
        name="delete-all-except-admin",
    ),
    path("delete/<uuid:userId>/", DeleteSingleUserView.as_view(), name="delete-user"),
    path(
        "delete-unverified/",
        DeleteUnverifiedUsersView.as_view(),
        name="delete-unverified",
    ),
    path("delete-account/", DeleteAccountView.as_view(), name="delete-account"),
    path(
        "update-role/<uuid:user_id>/",
